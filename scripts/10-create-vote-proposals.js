...
(async () => {
  try {
    // Create proposal to mint 420,000 new token treasury
    ...
    const executions = [
      {
        ...
        // Our nativeToken is ETH, nativeTokenValue is the amount of ETH we went
        // to send in this proposal. In this case, we are sending 0 ETH.
